package com.github.psydoc.event.enricher;
...
// This will be best for learning
public class UserDataProducer {
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        // FYI - We do .get() to ensure the writes to the topics are sequential, for the sake of learning
        ...
        producer.send(purchaseRecord("bob", "Mangoes (2)")).get();
        ...
        producer.send(purchaseRecord("robert", "Computer (4)")).get();
        producer.send(userRecord("robert", "First=robert,Last=downey,GitHub=tonyS")).get();
        producer.send(purchaseRecord("robert", "Books (4)")).get();
        producer.send(userRecord("robert", null)).get(); // delete for cleanup
        ...
        producer.send(purchaseRecord("alice", "Tables (5)")).get();
